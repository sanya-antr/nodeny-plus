    ...
    $.fn.simpleDatepicker = function(options) {
        ...
        function setupYearRange()
        {
             ...
             else if( opts.startdate )
            {
                ...
                {
                    opts.startdate = new Date( sv_convert_date(opts.startdate) );
                    startyear = opts.startdate.getFullYear();
                }
            }
        ...
        function newDatepickerHTML () {
            ...
            jQuery("thead",table).append('<tr class="controls"><th colspan="7"><span class="prevMonth">&laquo;</span>&nbsp;'+monthselect+yearselect+'&nbsp;<span class="nextMonth">&raquo;</span><br><br></th></tr>');
            ...
            if ( jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
                ...
                jQuery(this).click(function (ev) {
                    ...
                    if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
                        ...
                        initialDate = sv_convert_date(initialDate);
